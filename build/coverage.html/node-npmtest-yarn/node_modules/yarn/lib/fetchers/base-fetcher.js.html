...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-yarn/node_modules/yarn/lib/fetchers/base-fetcher.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-yarn/node_modules/yarn/lib/fetchers/base-fetcher.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-yarn/node_modules/yarn/lib/fetchers/</a> &#187; base-fetcher.js</div>
</div>
<div class="body">
...
&nbsp;
  getResolvedFromCached<span class="fstat-no" title="function not covered" >(hash) {</span>
...
&nbsp;
    return (_fs || _load_fs()).lockQueue.push(dest, (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      yield (_fs || <span class="branch-1 cbranch-no" title="branch not covered" >_load_fs())</span>.mkdirp(dest);
&nbsp;
...
&nbsp;
      yield (_fs || <span class="branch-1 cbranch-no" title="branch not covered" >_load_fs())</span>.writeFile(path.join(dest, (_constants || _load_constants()).METADATA_FILENAME), JSON.stringify({
        artifacts: [],
        remote: _this.remote,
