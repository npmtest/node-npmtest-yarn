...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-yarn/node_modules/yarn/lib/util/normalize-manifest/infer-license.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-yarn/node_modules/yarn/lib/util/normalize-manifest/infer-license.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-yarn/node_modules/yarn/lib/util/normalize-manifest/</a> &#187; infer-license.js</div>
</div>
<div class="body">
...
function inferLicense(license) {
  ...
  for (const licenseName in (_licenses || _load_licenses()).default) {
    const testLicense = (_licenses || <span class="branch-1 cbranch-no" title="branch not covered" >_load_licenses())</span>.default[licenseName];
