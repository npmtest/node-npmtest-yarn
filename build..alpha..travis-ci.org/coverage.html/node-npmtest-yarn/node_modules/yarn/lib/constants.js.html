...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-yarn/node_modules/yarn/lib/constants.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-yarn/node_modules/yarn/lib/constants.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-yarn/node_modules/yarn/lib/</a> &#187; constants.js</div>
</div>
<div class="body">
...
function getDirectory(category) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (process.platform === 'win32' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >process.env.LOCALAPPDATA)</span> {
<span class="cstat-no" title="statement not covered" >    return path.join(process.env.LOCALAPPDATA, 'Yarn', category);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return path.join(userHome, 'Library', 'Caches', 'Yarn');</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    pathKey = 'Path';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (const key in env) {</span>
<span class="cstat-no" title="statement not covered" >      if (key.toLowerCase() === 'path') {</span>
<span class="cstat-no" title="statement not covered" >        pathKey = key;</span>
      }
    }
  }
&nbsp;
...
&nbsp;
function getUid() {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (process.platform !== 'win32' &amp;&amp; process.getuid) {
